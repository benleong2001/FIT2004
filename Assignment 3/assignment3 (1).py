...
if __name__ == '__main__':
    availability = [[2, 0, 2, 1, 2], [3, 3, 1, 0, 0],
                    ...
                    [0, 2, 0, 1, 0], [1, 3, 3, 2, 0],
                    [0, 0, 1, 2, 1], [2, 0, 0, 3, 0]]
    # availability = [[3, 0, 0, 0, 3], [3, 0, 0, 0, 3]]
    # availability = [[0, 0, 0, 0, 0]]
    f = FlowNetwork(availability)
    # print("cap is " + str(ceil(0.44 * 10)))
    # print("0 - house")
    # print("1 to 6 - housemate")
    # print("7 to 33 - days")
    # print("33 to 53 - meals")
    # print("54 - all meals")
    # print("55, 56 - source, sink")
    print(allocate(availability))
    # print(compare_subs("radix sort and counting sort are both non comparison sorting algorithms",
    #       "counting sort and radix sort are both non comparison sorting algorithms"))
    # print(compare_subs("the quick brown fox jumped over the lazy dog",
    #       "my lazy dog has eaten my homework"))
    # print(compare_subs("fghij", "eelloeo"))
    # print(compare_subs("the dog chase the cat", "the dog hit the cat"))
    # print(compare_subs("phenolphthalein", "phenolpht halein"))
